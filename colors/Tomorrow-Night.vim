...
call <sid>hi("DiffAdd",      "", s:gui0B,  s:cterm0B, s:cterm01, "", "")
call <sid>hi("DiffChange",   "", s:gui03,  s:cterm03, s:cterm01, "", "")
call <sid>hi("DiffDelete",   "", s:gui08,  s:cterm08, s:cterm01, "", "")
call <sid>hi("DiffText",     "", s:gui0D,  s:cterm0D, s:cterm01, "", "")
call <sid>hi("DiffAdded",    "", s:gui0B,  s:cterm0B, s:cterm00, "", "")
call <sid>hi("DiffFile",     "", s:gui0B,  s:cterm08, s:cterm00, "", "")
call <sid>hi("DiffNewFile",  "", s:gui0B,  s:cterm0B, s:cterm00, "", "")
call <sid>hi("DiffLine",     s:gui0D, "",  s:cterm0D, s:cterm00, "", "")
call <sid>hi("DiffRemoved",  "", s:gui08,  s:cterm08, s:cterm00, "", "")
